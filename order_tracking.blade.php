  ...
  <div class="iphone">
    <div class="header">
      <div class="order-summary">
        <div class="order-status">Order# :</div>
    ...
    <div class="hero-img-container">
      ...
      <div class="pattern"></div>
       @if($retorderObject[0]->order_status =='C') 
			         
        <img src="images\food_1.gif" class="hero-img" id="gif_pic_prop">
			 
			  @elseif($retorderObject[0]->order_status =='BP')
          <img src="images\Making-pancake-loader.gif" class="hero-img" id="gif_pic_prop">
			   
			   @elseif($retorderObject[0]->order_status =='P')
				  <img src="images\loading.gif" class="hero-img" id="gif_pic_prop">
			  
        @elseif($retorderObject[0]->order_status =='OTW')
				  <img src="images\del.gif" class="hero-img" id="gif_pic_prop">
			  
		     @else
          <img src="images\done.gif" class="hero-img" id="gif_pic_prop">
    ...
    <div class="order-status-container">
      ...
      @if($retorderObject[0]->order_status =='P')
      ...
      @elseif($retorderObject[0]->order_status =='C')     
    ...
    <div class="order-details-container" style="text-align:center;">
    <a  href="{{url('/cravenation.home')}}" class="btn btn-warning btn-md">Back To Home</a>
</div>
  </body>
  </html>